        ...
        <div class="popup_wrapper hidden-sm hidden-xs">
            <div class="test">
                ...
                <div class="subscribe_area text-center">
                    <h2>Newsletter</h2>
                    <p>Subscribe to the Neha mailing list to receive updates on new arrivals, special offers and other
                                    ...
                                    <ul class="menu-overflow">
                                        ...
                                        <li><a href="#">shop</a>
                                            <ul>
                                                ...
                                                <li><a href="shop-list-view-1-col-container.html">list 1 column box</a>
                                                </li>
